...
export function GoogleButton() {
  return (
    <form action={signInWithGoogle}>
      <button
        type="submit"
        className="w-full flex items-center justify-center gap-2.5 rounded-[10px] border border-border bg-surface2 px-4 py-3 text-sm font-semibold text-text hover:bg-surface3 transition-colors"
      >
